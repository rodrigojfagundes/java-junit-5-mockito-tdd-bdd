...
public class SpyTest {
	...
	//Given / Arrange
		...
		//dessa forma nos estamos disendo q QUANDO FOR HAMADO O MOCKARRAYLIST.SIZE em vez de
		//retornar 0 (pois nao tem nada na LISTA) (THENRETURN) ele deve RETORNAR 5
		when(mockArrayList.size()).thenReturn(5);
		
		
		//add mais um ITEM ao MOCK no caso uma STRING de nome FOO-BAR
	...
	void testV2() {
		...
		//esperamos q o retorno de SPYARRAYLIST.SIZE seja 0, pois NAO TEM NADA NA LISTA
