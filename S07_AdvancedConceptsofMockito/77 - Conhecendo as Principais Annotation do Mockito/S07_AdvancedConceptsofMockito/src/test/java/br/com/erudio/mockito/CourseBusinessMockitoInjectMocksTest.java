...
//usando a ANNOTATION @EXTENDWITH e passando como parametro o MOCKITO
//para pd inciarlizar o MOCK com a ANNOTATION @MOCK ali em baixo
@ExtendWith(MockitoExtension.class)
class CourseBusinessMockitoInjectMocksTest {

	//usando a ANNOTATION @MOCK para INCIALIZAR O MOCK
	@Mock
	...
	void testCourseRelatedToSpring_When_UsingAMock() {
		//GIVEN
		//(quando) chamar o metodo RETRIEVECOURSE do MOCKSERVICE e passar o ARGUMENTO
	...
	void testDeleteCourseNotRelatedToSpring_UsingMockitoVerify_CallMethod_deleteCourse() {
		...
		//testa SE um CURSO ("REST API's RESTFul do 0 à Azure com ASP.NET Core 5 e Docker")
		//usando o NEVER para garantir q NAO sera chamado o metodo DELETECOURSE
		//
		//	verify(mockService, never()).deleteCourse("REST API's RESTFul do 0 à Azure com ASP.NET Core 5 e Docker");
