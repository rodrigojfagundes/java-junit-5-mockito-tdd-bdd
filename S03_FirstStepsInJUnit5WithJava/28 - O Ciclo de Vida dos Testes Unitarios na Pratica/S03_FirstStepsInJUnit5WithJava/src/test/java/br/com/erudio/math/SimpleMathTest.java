...
class SimpleMathTest {
	...
	//criando um metodo de nome SETUP q usa a ANNOTATION @BEFOREALL, ANNOTATION q serve para
	...
	//criando um metodo de nome CLENUP q usa a ANNOTATION @AFTERALL, ANNOTATION q serve para
	...
	//criando um metodo de nome AFTEREACHMETHOD q usa a ANNOTATION @AFTEREACH
	//metodos q usam essa ANNOTATION são exec a cada fez ter termina um METODO de TEST
	//
	@AfterEach
