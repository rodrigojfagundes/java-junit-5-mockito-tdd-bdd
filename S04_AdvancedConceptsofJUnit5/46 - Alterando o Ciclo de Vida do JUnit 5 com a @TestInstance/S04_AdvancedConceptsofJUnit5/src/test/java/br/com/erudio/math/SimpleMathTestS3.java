...
class SimpleMathTestS3 {
	...
	@AfterAll
	static void clenup() {
		//estamos colocando um SYSTEM.OUT.PRINTLN() com uma mensagem, pd poderia
		//esta fazendo uma configuração apos realizar todos os testes...
		System.out.println("Running @AFTERALL method!");
	}
	
	

	//os metodos q usam a ANNOTATION @BEFOREEACH sao executados antes de CADA METODO 
	//de TEST
	@BeforeEach
